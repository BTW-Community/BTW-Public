...
public class FCClientRenderLightningBolt extends Render
{
    ...
    {
        doRenderLightningBolt((FCEntityLightningBolt)par1Entity, par2, par4, par6, par8, par9);
    }
    
    public void doRenderLightningBolt( FCEntityLightningBolt entityBolt, 
    	double par2, double par4, double par6, float par8, float par9 )
    {
        ...
        double var13 = 0.0D;
        double var15 = 0.0D;
        Random var17 = new Random(entityBolt.m_lRenderSeed);
        ...
        {
            Random var46 = new Random(entityBolt.m_lRenderSeed);
