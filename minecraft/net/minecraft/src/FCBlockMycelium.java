...
public class FCBlockMycelium extends BlockMycelium
{
    ...
    private Icon m_iconTop; // field_94422_a in parent
    private Icon m_iconSnowSide; // field_94421_b in parent
    ...
    public void registerIcons( IconRegister register )
    {
        ...
        m_iconTop = register.registerIcon( "mycel_top" );
        m_iconSnowSide = register.registerIcon( "snow_side" );
    }
