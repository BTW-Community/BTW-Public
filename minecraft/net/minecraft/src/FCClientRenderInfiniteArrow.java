...
public class FCClientRenderInfiniteArrow extends Render
{
    public FCClientRenderInfiniteArrow()
    {
    }
    ...
    public void doRender(Entity entity, double d, double d1, double d2, 
            float f, float f1)
    {
        RenderArrow((FCEntityInfiniteArrow)entity, d, d1, d2, f, f1);
    }
    
    //************* Class Specific Methods ************//
    
    public void RenderArrow(FCEntityInfiniteArrow entityarrow, double d, double d1, double d2, 
            float f, float f1)
    {
        ...
        loadTexture( "/btwmodtex/fcinfinitearrow.png" );
