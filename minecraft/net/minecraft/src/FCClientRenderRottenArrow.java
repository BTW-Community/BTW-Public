...
public class FCClientRenderRottenArrow extends Render
{
    public FCClientRenderRottenArrow()
    {
    }
    ...
    public void doRender(Entity entity, double d, double d1, double d2, 
            float f, float f1)
    {
        RenderArrow((FCEntityRottenArrow)entity, d, d1, d2, f, f1);
    }
    
    //************* Class Specific Methods ************//
    
    public void RenderArrow(FCEntityRottenArrow entityarrow, double d, double d1, double d2, 
            float f, float f1)
    {
        ...
        loadTexture( "/btwmodtex/fcrotten.png" );
