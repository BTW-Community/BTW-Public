...
public class FCBlockShaft extends Block
{
    	...
    	int iNeighborI, int iNeighborJ, int iNeighborK, int iSide )
    {
    	...
    	int iFacing = GetFacing( blockAccess, myPos.i, myPos.j, myPos.k );
    	
    	if ( iSide == iFacing )
    	{
	   		return !FCClientUtilsRender.ShouldRenderNeighborFullFaceSide( 
    ...
    {    	
    	...
    	transformedBox.TiltToFacingAlongJ( GetFacing( renderBlocks.blockAccess, i, j, k ) );
    ...
    public AxisAlignedBB getSelectedBoundingBoxFromPool( World world, int i, int j, int k )
    {
    	...
    	{
    		transformedBox = m_boxSelectionSupporting.MakeTemporaryCopy();
    	}
    	else
    	{
    		transformedBox = m_boxSelection.MakeTemporaryCopy();
    	}
    	
    	transformedBox.TiltToFacingAlongJ( GetFacing( world, i, j, k ) );
