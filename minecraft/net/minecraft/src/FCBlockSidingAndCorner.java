...
public class FCBlockSidingAndCorner extends Block
{
    ...
    {
		blockIcon = register.registerIcon( m_sTextureName );
    }
    ...
    {
    	if ( blockID == FCBetterThanWolves.fcBlockWoodSidingItemStubID || 
			( ( iItemDamage & 1 ) == 0 && blockID != FCBetterThanWolves.fcBlockWoodCornerItemStubID ) ) // corner test
    	{
    		renderBlocks.setRenderBounds( 0F, 0F, 0F, m_dSidingHeight, 1F, 1F  );            	
    	}
    	else
    	{
    		renderBlocks.setRenderBounds( 
        		0.5F - ( m_dCornerWidth * 0.5F ), 0.5F - ( m_dCornerWidth * 0.5F ), 0.5F - ( m_dCornerWidth * 0.5F ),  
        		0.5F + ( m_dCornerWidth * 0.5F ), 0.5F + ( m_dCornerWidth * 0.5F ), 0.5F + ( m_dCornerWidth * 0.5F )  );
    	}
    	
    	if ( blockID == FCBetterThanWolves.fcBlockWoodSidingItemStubID ||
			blockID == FCBetterThanWolves.fcBlockWoodCornerItemStubID )
    	{
    		Icon woodTexture;
	        ...
	        switch ( iItemDamage )
	        {
	            case 1: // spruce
	            	...
	            	woodTexture = FCBetterThanWolves.fcBlockWoodSpruceSidingAndCorner.blockIcon;
	            	
	            	break;

	            case 2: // birch
	            	
	            	woodTexture = FCBetterThanWolves.fcBlockWoodBirchSidingAndCorner.blockIcon;

	            	break;

	            case 3: // jungle
	            	
	            	woodTexture = FCBetterThanWolves.fcBlockWoodJungleSidingAndCorner.blockIcon;
	                
	            	break;

	            case 4: // blood
	            	
	            	woodTexture = FCBetterThanWolves.fcBlockWoodBloodSidingAndCorner.blockIcon;
	                
	            	break;

	            default: // oak
	            	
	            	woodTexture = FCBetterThanWolves.fcBlockWoodOakSidingAndCorner.blockIcon;
	        }
