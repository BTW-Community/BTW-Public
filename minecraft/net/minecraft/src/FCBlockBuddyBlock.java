...
public class FCBlockBuddyBlock extends Block
{
    ...
    public void registerIcons( IconRegister register )
    {
        ...
        m_IconOn = register.registerIcon( "fcBlockBuddyBlock_on" );
        m_IconFront = register.registerIcon( "fcBlockBuddyBlock_front" );
        m_IconFrontOn = register.registerIcon( "fcBlockBuddyBlock_front_on" );
    }
