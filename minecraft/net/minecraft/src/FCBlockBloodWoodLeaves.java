...
public class FCBlockBloodWoodLeaves extends FCBlockLeaves
{
    ...
    private Icon m_IconLowDetail;
    
	@Override
    public void registerIcons( IconRegister register )
    {
		blockIcon = register.registerIcon( "leaves" );
        m_IconLowDetail = register.registerIcon( "leaves_opaque" );        
    }
    ...
    {
		// need to override this from parent class
    ...
    {
    	// this is a cludgey due to the need to call the super method, and its reliance on the graphicsLevel variable
		
    	graphicsLevel = Block.leaves.graphicsLevel; 
