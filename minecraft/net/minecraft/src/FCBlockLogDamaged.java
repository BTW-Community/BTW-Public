...
public class FCBlockLogDamaged extends Block
{
    ...
    public void registerIcons( IconRegister register )
    {
		...
		m_IconStumpTop = register.registerIcon( "fcBlockTrunkTop" );
    }
    ...
    {
    	int iFacing = SetCurrentModelForBlock( renderBlocks.blockAccess, i, j, k );
    ...
    public AxisAlignedBB getSelectedBoundingBoxFromPool( World world, int i, int j, int k )
    {
		...
		AxisAlignedBB tempSelectionBox = m_boxSelectionArray[iDamageLevel].MakeTemporaryCopy();
