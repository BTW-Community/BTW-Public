...
abstract class OverrideBase implements Comparable<OverrideBase> {
    ...
    private Map<String, FakeResourceLocation> getAlternateTextures() {
        Map<String, FakeResourceLocation> tmpMap = new HashMap<String, FakeResourceLocation>();
        for (Map.Entry<String, String> entry : properties.entrySet()) {
            ...
            FakeResourceLocation resource = TileLoader.parseTileAddress(properties.getResource(), value);
            if (resource != null) {
