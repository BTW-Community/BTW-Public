...
public class FancyDial {
    ...
    private static final Map<TextureStitched, FakeResourceLocation> setupInfo = new IdentityHashMap<TextureStitched, FakeResourceLocation>();
    private static final Map<TextureStitched, FancyDial> instances = new IdentityHashMap<TextureStitched, FancyDial>();
    ...
    private FancyDial(TextureStitched icon, PropertiesFile properties) {
        ...
        originX = IconAPI.getIconOriginX(icon);
        originY = IconAPI.getIconOriginY(icon);
        ...
        itemsFBO = new FBO(itemsTexture, originX, originY, width, height);
    ...
    public String toString() {
        return String.format("FancyDial{%s, %dx%d @ %d,%d}", name, width, height, originX, originY);
    }
    ...
    private class Layer {
        ...
        Layer(FakeResourceLocation textureName, float scaleX, float scaleY, float offsetX, float offsetY, float rotationMultiplier, float rotationOffset, BlendMethod blendMethod, boolean debug) {
