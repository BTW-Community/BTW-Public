...
public class ColorizeBlock {
    ...
    private static void reloadBlockColors(PropertiesFile properties) {
        for (Map.Entry<String, String> entry : properties.entrySet()) {
            ...
            FakeResourceLocation resource = TexturePackAPI.parseResourceLocation(Colorizer.COLOR_PROPERTIES, key);
            if (resource == null) {
                continue;
            }
        ...
        for (FakeResourceLocation resource : ResourceList.getInstance().listResources(ColorMap.BLOCK_COLORMAP_DIR, ".properties", false)) {
        ...
        List<FakeResourceLocation> unusedPNGs = new ArrayList<FakeResourceLocation>(ColorMap.unusedPNGs);
