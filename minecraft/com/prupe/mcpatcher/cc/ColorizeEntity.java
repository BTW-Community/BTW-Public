...
public class ColorizeEntity {
    private static final FakeResourceLocation LAVA_DROP_COLORS = TexturePackAPI.newMCPatcherResourceLocation("/misc/lavadropcolor.png");
    private static final FakeResourceLocation MYCELIUM_COLORS = TexturePackAPI.newMCPatcherResourceLocation("/misc/myceliumparticlecolor.png");
    private static final FakeResourceLocation XPORB_COLORS = TexturePackAPI.newMCPatcherResourceLocation("/misc/xporbcolor.png");
